...
This repository contains the code used to analysis the voting and attendance histories of members of the 26th Irish Seanad (Senate).

The analysis found that a subset of Senators regularly do not vote on voting days. In addition, for some Senators, there was evidence of attendance (defined as either a recorded vote or a verbal contribution to the debate) on <30% of the days they claimed they attended for the purpose of the parliamentary allowance.
...
```{r fig1, echo = FALSE, results="asis", fig.pos = "H", fig.cap='Summary of voting activity by Senator', out.width='80%', fig.align='center'}
...
```{r fig2, echo = FALSE, results="asis", fig.pos = "H", fig.cap='Number of voting days a Senator voted on versus number of voting days for which they claimed attendance. Line indicates a 1:1 relationship.', out.width='80%', fig.align='center'}
...
```{r fig3, echo = FALSE, results="asis", fig.pos = "H", fig.cap='Number of voting days with evidence of attendance (vote/contribution) vs number of voting days claimed as attended. Line indicates a 1:1 relationship.',fig.align='center', out.width='80%'}
